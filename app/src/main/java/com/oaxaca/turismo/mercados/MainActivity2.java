    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Thread hilo = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Peticiones peticion = new Peticiones(getApplicationContext(),MainActivity.base_url+"Mercado/mercados/"+MainActivity.llave);
                Peticiones peticion2 = new Peticiones(getApplicationContext(),MainActivity.base_url+"Mercado/mercadoById/"+MainActivity.llave+"/"+ihm);
                Peticiones peticion3 = new Peticiones(getApplicationContext(),MainActivity.base_url+"Mercado/imgFromMercado/"+MainActivity.llave+"/"+ihm);
                Peticiones peticion4 = new Peticiones(getApplicationContext(),MainActivity.base_url+"Mercado/localesDelMercado/"+MainActivity.llave+"/"+ihm);
